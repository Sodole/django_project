...
class TestView(TestCase):
    ...
    def test_post_list(self):
        ...
        # 2.2 "아직 게시물이 업습니다"라는 문구가 보인다.
        main_area = soup.find('div', id="main-area")
        self.assertIn('아직 게시물이 없습니다.', main_area.text)

        # 3.1 게시물이 2개 있다면
        post_001 = Post.objects.create(title="첫번째라구", content="Hello World. we are the world.", author=self.user_trump)
        post_002 = Post.objects.create(title="두번째라구요", content="1등이 전부는 아니잖아요?", author=self.user_obama)
